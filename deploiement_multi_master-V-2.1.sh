...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#   Version script: 2.1
#   Deploiement sur Rocky Linux 9.0 minimum
...
# - Le service DHCPD est installés sur le loadBalancer                      		#
...
appHAProxy="haproxy iproute-tc policycoreutils-python-utils dhcp-server"
...
# Fonction de configuration du fichier hosts
EtcHosts () {
vrai="1"
cat <<EOF > /etc/hosts
127.0.0.1 localhost
...
172.21.0.103 worker1-k8s.mon.dom  w1.mon.dom
172.21.0.104 worker2-k8s.mon.dom  w2.mon.dom
172.21.0.105 worker3-k8s.mon.dom  traefik.mon.dom
EOF
vrai="0"
nom="Configuration du fichier hosts"
}
